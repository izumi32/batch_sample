...
ActiveRecord::Schema.define(version: 2021_12_08_175021) do
  ...
  create_table "user_scores", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", comment: "ユーザーが獲得した得点", force: :cascade do |t|
    t.bigint "user_id", null: false, comment: "ユーザー"
    t.integer "score", default: 0, null: false, comment: "得点"
    t.datetime "received_at", null: false, comment: "得点を獲得した日時"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
